...
class AgriAssistant:
    ...
    def get_advice(self, disease: str, confidence: float, region: Optional[str] = None, language: str = "en") -> str:
        """Get agricultural adivice based on detected disease and confidence level."""
        if not self.model:
        ...
        if region:
            prompt += f" The farm is located in {region}. Tailor the advice to this region."

        if language and language != "en":
            prompt += f" Provide the advice in {language}."
